...
To build the final jar and optimize the fundstransferapi application for production, run:
...
Then navigate to [http://localhost:8794](http://localhost:8794) in your browser.
