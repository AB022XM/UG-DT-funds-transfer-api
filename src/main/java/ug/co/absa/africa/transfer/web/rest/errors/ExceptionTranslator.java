...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof ug.co.absa.africa.transfer.service.EmailAlreadyUsedException ||
            ex instanceof ug.co.absa.africa.transfer.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof ug.co.absa.africa.transfer.service.InvalidPasswordException
